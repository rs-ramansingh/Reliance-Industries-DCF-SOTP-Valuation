...
![Valuation Summary](Screenshots/01_Cover_Valuation_Summary.png)

### Valuation Dashboard Reconciliation
![Valuation Dashboard Reconciliation](Screenshots/11_Valuation_Dashboard_Reconciliation.png)

### Market-Relative Benchmarking
![Comparable Company Analysis](Screenshots/09_Comparable_Company_Analysis.png)

### 4-String Valuation Matrix   
![The 4-String Valuation Matrix Layout](Screenshots/08_String_Valuation_Matrix.png)
...
![SOTP Valuation](Screenshots/05_SOTP_Valuation.png)

### Sensitivity Analysis

![DCF Sensitivity](Screenshots/06_DCF_Sensitivity.png)

![SOTP Sensitivity](Screenshots/07_SOTP_Sensitivity.png)

### Dynamic Risk & Scenario Analysis
![Active Scenario Switch Engine](Screenshots/10_Scenario_Switch_Engine.png)
